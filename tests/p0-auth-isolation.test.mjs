...
assert.deepEqual(
  staticScripts,
  ['environment-config.js', 'resume-diagnostics.js', 'postgres-api-client.js', 'google-sheets-config.js', 'state-store.js', 'postgres-offline.js', 'postgres-cloud.js', 'account-security.js', 'cloud-sync.js', 'google-sheets-cloud.js', 'login.js', 'pwa.js'],
  '登入前只可載入安全生命週期診斷、設定、資料容錯、驗證連線、登入與 PWA 安裝程式'
);
