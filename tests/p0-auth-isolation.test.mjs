...
assert.deepEqual(
  staticScripts,
  ['environment-config.js', 'postgres-api-client.js', 'google-sheets-config.js', 'state-store.js', 'postgres-offline.js', 'postgres-cloud.js', 'account-security.js', 'cloud-sync.js', 'google-sheets-cloud.js', 'login.js', 'pwa.js'],
