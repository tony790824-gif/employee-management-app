...
loginMark(interactive, 'AUTHORIZE_REDIRECT_REQUESTED', { reason: 'USER_LOGIN', run_id: 2 });
loginMark(interactive, 'AUTH_REDIRECT_START', { run_id: 2 });
loginMark(interactive, 'AUTH_INIT_END', { run_id: 1, stale_result_ignored: true, success: false });
