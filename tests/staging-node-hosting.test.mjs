...
const requiredBlueprintLines = [
  ...
  'key: DATABASE_SSL',
  'value: require',
  'key: BANK_RATE_LIMIT_ENABLED',
  'value: true',
  'key: BANK_RATE_LIMIT_SESSION_PER_MINUTE',
  'value: 20',
  'key: BANK_RATE_LIMIT_READ_PER_MINUTE',
  'value: 180',
  'key: BANK_RATE_LIMIT_COMMAND_PER_MINUTE',
  'value: 60',
...
for (const key of [
  ...
  'BANK_WEB_PUSH_ENABLED',
  'BANK_WEB_PUSH_PUBLIC_KEY',
  'BANK_WEB_PUSH_PRIVATE_KEY',
  'BANK_WEB_PUSH_SUBJECT'
]) {
  assert.match(
    blueprint,
