...
assert.equal(evidenceHashes.publicDomainOperationsCostEvidence.domain.approvedDomainSelected, false);
assert.equal(evidenceHashes.publicDomainOperationsCostEvidence.domain.initialPriceStatus, 'UNKNOWN');
