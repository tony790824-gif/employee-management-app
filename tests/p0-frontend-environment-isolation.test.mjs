...
assert.match(rehearsalWorker, /banke-staging-postgres-v11/);
assert.match(rehearsalWorker, /environment-config\.js\?v=banke-staging-postgres-v11/);
assert.match(rehearsalWorker, /manifest\.webmanifest\?v=banke-staging-postgres-v11/);
assert.match(rehearsalIndex, /src="environment-config\.js\?v=banke-staging-postgres-v11"/);
assert.match(rehearsalIndex, /href="manifest\.webmanifest\?v=banke-staging-postgres-v11"/);
assert.notEqual(
